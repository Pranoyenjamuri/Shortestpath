...
@Config(constants = BuildConfig.class, sdk = 21, manifest = "src/main/AndroidManifest.xml", packageName = "com.pranoy.lowcostpath")
public class LowCostPathPageAdapterTest {
    ...
    public void setUp() {
        ...
        pagerAdapter = new LowCostPathPageAdapter(fragmentManager);
    }
    ...
    public void firstItemOfTheAdapterIsTheExamplesFragment() {
        assertThat(pagerAdapter.getItem(0), instanceOf(LowCostPathPageAdapter.class));
    }

    @Test
    public void secondItemOfTheAdapterIsTheCustomFragment() {
        assertThat(pagerAdapter.getItem(1), instanceOf(LowCostPathPageAdapter.class));
    }
